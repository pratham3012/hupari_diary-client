...
Activity activity;
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
       ...
       Picasso.get().load(catcalss.getCatImage()).into(holder.catImage);
        ...
        holder.catImage.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
                ...
                AlertDialog.Builder builder
                        = new AlertDialog
                        .Builder(activity);
                builder.setMessage("Do you want to delete"+holder.catText.getText().toString()+"  ?");
                        ...
                        .setPositiveButton(
                                ...
                                new DialogInterface
                                                        ...
                                                        int which)
                                    {
                                        ...
                                        StringRequest request=new StringRequest("https://mibtechnologies.in/hupariapp/deletecat.php?uid="+ holder.catText.getText().toString().trim() , new Response.Listener<String>() {
                                            @Override
        ...
        holder.catText.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                ...
                AlertDialog.Builder builder
                        = new AlertDialog
                        .Builder(activity);
                builder.setMessage("Do you really want to delete "+holder.catText.getText().toString()+"  ?");
                builder.setTitle("Alert !");
                builder.setCancelable(false);
